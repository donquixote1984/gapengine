...
namespace assetpacker {
    ...
    const int MAX_TEXTURE_CHANNELS = 10;
    ...
    struct HeaderStruct
    {
        ...
        int mcount = 0;                 //4
        int tcount = 0;                 //4
        SizeOffsetTypeMime modelSizeAndOffset[MAX_MODEL_COUNT]; // 160
        SizeOffsetTypeMime textureSizeAndOffset[MAX_TEXTURE_CHANNELS]; //160
        int margin = 0; // 4
    };  // size: 160 + 160+ 16 = 336;
